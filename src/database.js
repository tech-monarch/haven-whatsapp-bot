...
/**
 * Ensure the bot_sessions table exists.
 * Called once at startup by session.js.
 */
async function ensureBotSchema() {
  ...
  `);
  await query(`
    CREATE INDEX IF NOT EXISTS idx_bot_sessions_updated
    ON bot_sessions (updated_at);
  `);
}

// Re-export with new function added
module.exports = Object.assign(module.exports, { ensureBotSchema });
